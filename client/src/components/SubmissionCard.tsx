            ...
            <div className="flex items-top justify-between">
                ...
                <div>
                    <button onClick={async()=>{
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 16" id="Bin--Streamline-Block-Free" height={16} width={16} ><desc>{"\n    Bin Streamline Icon: https://streamlinehq.com\n  "}</desc><path fill="#fcfcff" fillRule="evenodd" d="M16 4v2h-2v10H2V6H0V4h4c0 -2.20914 1.79086 -4 4 -4 2.2091 0 4 1.79086 4 4l4 0ZM8.00005 2C9.10461 2 10 2.89544 10 4L6.00006 4c0 -1.10455 0.89543 -2 1.99999 -2Z" clipRule="evenodd" strokeWidth={1} /></svg>
                    </button>
                </div>
            </div>
        </div>
